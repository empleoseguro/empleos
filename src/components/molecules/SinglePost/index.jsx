        ...
        <div className="card rounded-0 shadow bg-light">
            <article>
                ...
                <div className="d-flex flex-column flex-md-row mt-3 justify-content-center">
                    ...
                    <div className="d-none d-xl-flex border mx-sm-5" style={{ width: '380px', height: '400px' }}></div>
                </div>
            </article>
        </div>
    )
...
function shareOnFacebook() {
    const facebookUrl = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://empleoseguro.tech` + window.location.pathname)}`;
