    ...
    return (
        <>
            ...
            <div className='container-fluid bg-light d-flex flex-column justify-content-between flex-sm-row'>
                ...
                <div className='w-25 w-sm-25 border pe-sm-5'>ADS</div>
            </div>
        </>
    )
}
